...
>
	<!-- Glow overlay -->
	<div
		class="card-glow pointer-events-none absolute inset-0 z-10 opacity-0 transition-opacity duration-200"
	></div>
	...
	<div class="flex flex-1 flex-col gap-3 p-5">
		...
		<div class="mt-auto flex items-center gap-2 pt-2">
			...
			<Button
				...
				variant="outline"
				size="xs"
				class="ml-auto border-accent/40 font-mono text-accent hover:border-accent hover:bg-accent/5 hover:text-accent"
			>
				{m.details()} →
			</Button>
		</div>
